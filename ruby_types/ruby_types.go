...
// // Assuming that E_RequiredField is the variable generated by protoc
// // for the required_field extension and that it is in the appropriate package.
// func isFieldRequired(field protoreflect.FieldDescriptor) (bool, error) {
// 	if field.Options() == nil {
// 		// No options set for this field.
// 		return false, nil
// 	}

// 	opts := field.Options().(*descriptorpb.FieldOptions) // Cast to the correct type.
// 	if proto.HasExtension(opts, E_RequiredField) {
// 		ext := proto.GetExtension(opts, E_RequiredField)
// 		required, ok := ext.(bool) // Assert that the extension is of type bool.
// 		if !ok {
// 			return false, fmt.Errorf("required_field extension is not of type bool")
// 		}
// 		return required, nil
// 	}

// 	// Extension not present, field is not required.
// 	return false, nil
// }
